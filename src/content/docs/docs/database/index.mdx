...
:::tip
Many mobs and NPCs were placed to **Classic** locations.  
To avoid any issues, we recommend using the [OpenDAoC Client][1] if you plan to use this database.
:::
...
To combine the files back together, users should download the [SQLSplit][2] utility from the [SQLSplit GitHub Releases page][3] and reference the tool's README for its usage.

Alternatively, users can work with the single table files as needed.

[1]: /docs/client
[2]: https://github.com/claitz/SQLSplit
[3]: https://github.com/claitz/SQLSplit/releases